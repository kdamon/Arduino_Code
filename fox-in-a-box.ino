...
String Text = "PPRAA Fox Hunt Catch me if you can! See ya! KD0TRD"; // The message you want to transmit in morse code.
String AltText = "PPRAA Fox Hunt Fox found Thanks 4 playing! KD0TRD"; // An alternate message to transmit if pin 10 is held high on startup.
